...
public class mathmatch : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        CARDS[2].Add(new card { kie = 13, questions = new string[] { "8+5", "6+7", "15-2", "19-6", "13x1", "1x13", "26/2", "39/3" } });
        CARDS[2].Add(new card { kie = 14, questions = new string[] { "9+5", "8+6", "19-5", "17-3", "2x7", "14x1", "28/2", "42/3" } });
        CARDS.Add(3, new List<card>());
        CARDS[3].Add(new card { kie = 16, questions = new string[] { "8+8", "10+6", "20-4", "26-10", "8x2", "4x4", "32/2", "48/3" } });
        CARDS[3].Add(new card { kie = 18, questions = new string[] { "15+3", "11+7", "26-8", "20-2", "6x3", "9x2", "36/2", "54/3" } });
        ...
        CARDS[4].Add(new card { kie = 28, questions = new string[] { "19+9", "14+14", "37-9", "45-17", "2x14", "4x7", "84/3", "112/4" } });
        CARDS[4].Add(new card { kie = 31, questions = new string[] { "18+13", "24+7", "50-19", "45-14", "1x31", "31x1", "93/3", "155/5" } });
        CARDS.Add(5, new List<card>());
        CARDS[5].Add(new card { kie = 48, questions = new string[] { "34+14", "26+22", "86-38", "71-23", "8x6", "4x12", "240/5", "384/8" } });
